<?php /* Menú público con carrito mejorado + dirección/mesa/notas + scroll + botones flotantes */ ?>
<!doctype html>
<html lang="es">
<head>
  <meta charset="utf-8" />
  ...
  <!-- Botón carrito flotante <base href="/menudigitalprueba/">-->
...
<body>
  ...
  <!-- Botón fijo al administrador -->
  <a href="../admin/login.php" class="admin-btn" title="Ir al panel administrador">
    <i class="bi bi-gear"></i>
  </a>

  <!-- Botón subir -->
  <div id="btnTop"><i class="bi bi-arrow-up"></i></div>
  ...
  <div class="container py-4">
    <div id="header" class="d-flex align-items-center gap-3 mb-4">
      ...
      <div class="flex-grow-1">
        ...
        <small class="biz-subtitle">Menú digital, haz tu pedido por WhatsApp</small>
      </div>
    </div>
    ...
    <div class="row g-2 mb-3">
      ...
      <div class="col-12">
        ...
        <div id="catPills" class="categories-scroll"></div>
      </div>
    </div>
  ...
  <footer>
    <div class="social mb-2">
      <a href="https://wa.me/18099150634" target="_blank" aria-label="WhatsApp"><i class="bi bi-whatsapp"></i></a>
      <a href="https://www.instagram.com/devquis" target="_blank" aria-label="Instagram"><i class="bi bi-instagram"></i></a>
      <a href="https://www.tiktok.com/@devquis" target="_blank" aria-label="TikTok"><i class="bi bi-tiktok"></i></a>
    </div>
    <div class="small">© <span id="year"></span> DevQuis - Soluciones Tecnológicas</div>
  </footer>

  <!-- Scripts -->
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
  <script>
    // Detectar base automáticamente para APIs
    (function(){
